...
ActiveRecord::Schema.define(version: 2023_01_24_074159) do
  ...
  create_table "courses", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.integer "road_type", default: 0
    t.integer "toilet", default: 0
    t.integer "undulation", default: 0
    t.integer "signal", default: 0
    t.integer "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "address"
